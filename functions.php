<?php
/**
 * seltzerUnderscores functions and definitions.
 *
...
if ( ! function_exists( 'seltzerunderscores_setup' ) ) :
/**
 ...
 */
function seltzerunderscores_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on seltzerUnderscores, use a find and replace
	 * to change 'seltzerunderscores' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'seltzerunderscores', get_template_directory() . '/languages' );
	...
	add_theme_support( 'custom-background', apply_filters( 'seltzerunderscores_custom_background_args', array(
 ...
 */
function seltzerunderscores_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'seltzerunderscores_content_width', 640 );
}
add_action( 'after_setup_theme', 'seltzerunderscores_content_width', 0 );
...
add_action( 'widgets_init', 'seltzerunderscores_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function seltzerunderscores_scripts() {
	wp_enqueue_style( 'seltzerunderscores-style', get_stylesheet_uri() );
...
add_action( 'wp_enqueue_scripts', 'seltzerunderscores_scripts' );
